...
public class Create {
    ...
    private CreateTransitGatewayConnectPeerRequest translateModelToRequest(ResourceModel model) {
        ...
        return CreateTransitGatewayConnectPeerRequest.builder()
                ...
                .transitGatewayAddress(model.getTransitGatewayAddress())
                .peerAddress(model.getPeerAddress())
                .bgpOptions(TransitGatewayConnectRequestBgpOptions.builder().peerAsn(model.getBgpOptions().getPeerAsn()).build())
    ...
    private boolean stabilize(
        ...
        model.setTransitGatewayConnectPeerId(awsResponse.transitGatewayConnectPeer().transitGatewayConnectPeerId());
        ...
        return TransitGatewayConnectPeerState.AVAILABLE.toString().equals(currentState);
    }
